 ...
 */
final class Version20210706225313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP id_user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE competition CHANGE terrain_id terrain_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE personne ADD id_user INT NOT NULL');
        $this->addSql('ALTER TABLE planning CHANGE terrain_id terrain_id INT DEFAULT NULL');
